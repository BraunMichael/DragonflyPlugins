...
class SEMImportScaleCrop_4924010623d611e88ff4448a5b5d70c0(OrsPlugin):
    ...
    @menuItem('SEM Import')
    def SEMmenu(cls):
        aMenuItem = Menu(title='SEM Import Crop Scale',
                         id_='SEMImportScaleCrop_4924010623d611e88ff4448a5b5d70c0_1',
                         section='',
                         action='SEMImportScaleCrop_4924010623d611e88ff4448a5b5d70c0.importSEM()')
        return aMenuItem

    @classmethod
    def importSEM(cls):
        # instance = SEMImportScaleCrop_4924010623d611e88ff4448a5b5d70c0()
        root = Tk()
        root.withdraw()
        filesFolder = filedialog.askdirectory(initialdir=r'E:\Google Drive\Research SEM', title='Choose directory with SEM images to import')
        if not filesFolder:
            quit()
        ...
        for name in fileNames:
            ...
            scaleBarMicronsPerPixel = scaleBarMicronsPerPixelDict[getNakedNameFromFilePath(name)]
            ...
            newDragonflyChannel = OrsImageLoader.createDatasetDeterminingGeometryFromFiles([croppedFileName])
            newDragonflyChannel.setXSpacing(scaleBarMicronsPerPixel/1e6)
            newDragonflyChannel.setYSpacing(scaleBarMicronsPerPixel/1e6)
            newDragonflyChannel.setZSpacing(scaleBarMicronsPerPixel/1e6)
            newDragonflyChannel.publish()
